...
MovePodoboo:
  ...
  bne PdbM                   ;branch to move enemy if not expired
    farcall InitPodoboo        ;otherwise set up podoboo again
    lda PseudoRandomBitReg+1,x ;get part of LSFR
    ora #%10000000             ;set d7
...
;-------------------------------------------------------------------------------------
; Extra bank used mostly for object initialization code
...
;jump engine table for newly loaded enemy objects
  ...
  .word PlatLiftDown
  .word InitBowser
  .word NoInitCode ; PwrUpJmp   ;possibly dummy value
  .word Setup_Vine
...
DifLoop:
  ...
  farcall PlayerLakituDiff   ;move enemy, change direction, get value - difference
...
MaxCC:
  sty R0                     ;store whatever pseudorandom bits are in Y
